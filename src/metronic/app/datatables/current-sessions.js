          ...
          render: (item) => {
            ...
            return `
              <div class="flex items-center gap-2.5">
                <div class="shrink-0">
                  <img class="h-9 rounded-full" src="/static/${prefix}/dist/media/avatars/${item.avatar}">
                </div>
          ...
          render: (item) => {
            ...
            return `
              <div class="flex items-center gap-1.5">
                <img alt="flag" class="h-4 rounded-full" src="/static/${prefix}/dist/media/flags/${item.flag}">
